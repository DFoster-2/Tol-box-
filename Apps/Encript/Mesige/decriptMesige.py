...
def encrypt():
  ...
  for currentcharacter in stringtoencrypt:
    ...
    if currentcharacter in alphabet:
      ...
      encrypyrdstring = encrypyrdstring + alphabet[newposition]
  string = " Your encrypted message is " + str(stringtoencrypt) + "\n Your decrypted message is " + str(encrypyrdstring)
...
def code_incripter():
  ...
  stringtoencryptLabel = Label(encrypterRoot,text="Please enter a message to decrypt:")
  ...
  shiftamountstrLabel = Label(encrypterRoot,text="To decrypt, enter a your key.")
